            ...
            <div className="left" style={{ width: "293px",height:'414px' }}>
                ...
                <Grid container rowGap={2} className="right" style={{ width: "360px",height:'304px' }}>
                    ...
                    <Grid xs={12} style={{width:'100%'}}><Grid container xs={12} columnGap={2}>
                        <Grid xs={8}><Button onClick={()=>{
                             setplanview(!planview)
                        }} variant="contained" fullWidth sx={{fontSize:'14px',fontWeight:'600',textTransform:'none',display:'flex',alignItems:'center',background:'#2388FF'}}  > <img src={King} alt="" style={{marginRight:'10px'}} /> Use this template</Button></Grid>
        ...
        }}/>
{
 ...
 <div style={{display:"flex",alignItems:'center',justifyContent:'space-between',width:'100%'}}><span style={{fontSize:'15px',fontWeight:'600',color:'white'}}>₹ 100</span> <Button onClick={()=>{
     setplanview(!planview)
 }} varient='contained' style={{background:'white'}}> Buy now</Button></div></div>
}
        </Grid>
